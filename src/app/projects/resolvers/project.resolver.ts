...
export class ProjectResolver {
    ...
    @Query("projects")
    @Access(GRANT_TOKEN.FRONT_ACCESS)
    public async getProjects(@Args("search") search: string, @Args("pagination") pagination: Pagination, @Context() ctx: GqlContext): Promise<Project[]> {
    ...
    @Access(GRANT_TOKEN.FRONT_ACCESS)
    public async delete(@Args("id") id: number, @UUID() uuid: string, @Context() ctx: GqlContext): Promise<boolean> {
    ...
    @Access(GRANT_TOKEN.FRONT_ACCESS)
    public async update(@Args("id") id: number, @Args("data") data: ProjectUpdate, @UUID() uuid: string, @Context() ctx: GqlContext): Promise<Project> {
        //check permission delete project
    ...
    @ResolveField("totalSupplyListQty")
    ...
    @ResolveField("unusedSupplyListQty")
