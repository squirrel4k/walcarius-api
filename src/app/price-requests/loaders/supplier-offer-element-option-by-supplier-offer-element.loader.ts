...
@Injectable()
export class SOEOptionBySupplierOfferElementLoader extends OneToManySqlLoader<SupplierOfferElementOptionSql> {

    public constructor(
        @InjectRepository(SupplierOfferElementOptionSql) supplierOfferElementOptionRepo: Repository<SupplierOfferElementOptionSql>
    ) {
        super(supplierOfferElementOptionRepo, "SOEOptionsBySupplierOfferElement", "supplierOfferElementId");
    }
}